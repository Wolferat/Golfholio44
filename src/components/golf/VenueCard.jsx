...
export default function VenueCard({ item, saved, onToggleSave, onOpen, index = 0 }) {
  ...
  return (
    ...
    >
      <div className={cn('relative aspect-[16/9] overflow-hidden', !photo && 'fairway-gradient')}>
        {photo && <Image src={photo} fittingType="fill" className="absolute inset-0 h-full w-full" />}
